...
function useGenerateImage(args) {
    ...
    const generateImage = useCallback((callback) => __awaiter(this, void 0, void 0, function* () {
...
function useCurrentPng(options) {
    const ref = useRef(null);
    const [isLoading, setIsLoading] = useState(false);
    const getPng = useCallback((callback) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        if ((_a = ref.current) === null || _a === void 0 ? void 0 : _a.parentElement) {
            setIsLoading(true);
            return yield html2canvas(ref.current.parentElement, Object.assign({ logging: false }, options)).then((canvas) => {
                if (callback) {
    ...
    constructor() {
        ...
        this.getPng = (options) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = this.chartRef.current) === null || _a === void 0 ? void 0 : _a.parentElement) {
                ...
                return yield html2canvas(this.chartRef.current.parentElement, Object.assign({}, options)).then((canvas) => {

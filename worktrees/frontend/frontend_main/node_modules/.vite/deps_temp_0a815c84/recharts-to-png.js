...
// node_modules/recharts-to-png/dist/index.esm.js
...
function useGenerateImage(args) {
  ...
  const generateImage = (0, import_react.useCallback)((callback) => __awaiter2(this, void 0, void 0, function* () {
    if (ref === null || ref === void 0 ? void 0 : ref.current) {
      setIsLoading(true);
      return yield html2canvas_esm_default(ref.current, Object.assign({ logging: false }, args === null || args === void 0 ? void 0 : args.options)).then((canvas) => {
        if (callback) {
...
function useCurrentPng(options) {
  const ref = (0, import_react.useRef)(null);
  const [isLoading, setIsLoading] = (0, import_react.useState)(false);
  const getPng = (0, import_react.useCallback)((callback) => __awaiter2(this, void 0, void 0, function* () {
    var _a;
    if ((_a = ref.current) === null || _a === void 0 ? void 0 : _a.parentElement) {
      setIsLoading(true);
      return yield html2canvas_esm_default(ref.current.parentElement, Object.assign({ logging: false }, options)).then((canvas) => {
        if (callback) {
...
var CurrentPng = class extends import_react.Component {
  constructor() {
    super(...arguments);
    ...
    this.getPng = (options) => __awaiter2(this, void 0, void 0, function* () {
      var _a;
      if ((_a = this.chartRef.current) === null || _a === void 0 ? void 0 : _a.parentElement) {
        this.setState({ isLoading: true });
        return yield html2canvas_esm_default(this.chartRef.current.parentElement, Object.assign({}, options)).then((canvas) => {
...
html2canvas/dist/html2canvas.esm.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=recharts-to-png.js.map

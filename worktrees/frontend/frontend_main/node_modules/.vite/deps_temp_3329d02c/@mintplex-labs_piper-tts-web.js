...
var _TtsSession = class _TtsSession2 {
  ...
  async init() {
    const { createPiperPhonemize } = await import("./piper-o91UDS6e-RGHACA7M.js");
    __privateSet(this, _createPiperPhonemize, createPiperPhonemize);
    __privateSet(this, _ort, await import("./ort.min-G2BAQZ5E.js"));
...
async function voices() {
  try {
    ...
    const LOCAL_VOICES_JSON = await import("./voices_static-D_OtJDHM-AL5TK6RQ.js");
